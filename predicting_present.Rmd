...
start in 2005-06-01." (Choi & Varian, 2011)
...
The MAE for the base model is `r maebase` while the MAE for the trends model `r maetrends`. There is a 7.21% greater error for the trends model compared to the base model. 
...
The MAE for the base model is `r mae_base_re` while the MAE for the trends model `r mae_trend_re`. There is a 21.80% improvement for the trends model compared to the base model. 
