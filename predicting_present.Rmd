...
The MAE for the base model is `r maebase` while the MAE for the trends model `r maetrends`. There is a 7.21%  between the base and trends model. 


## Expansion 1: Is this technique useful today?
