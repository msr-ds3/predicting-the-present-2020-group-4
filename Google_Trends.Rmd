...
```{r baseline-model_author_insample}
...
```{r trendline-model_author_insample}
...
```{r trendline-model_raw_insample}
...
```{r baseline-model_raw_ext_insample}
...
```{r trendline-model_raw_ext_insample}
